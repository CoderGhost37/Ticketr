...
export function SellerEventCard({
	...
	return (
		<div
			className={`bg-white p-6 rounded-lg shadow-sm border ${event.is_cancelled ? "border-red-200" : "border-gray-200"} overflow-hidden`}
		>
			<div className="flex items-start gap-6">
				{/* Event Image */}
				{imageUrl && (
					<div className="relative sm:w-40 sm:h-40 w-28 h-28 rounded-lg overflow-hidden shrink-0">
